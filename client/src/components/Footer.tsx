        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              />
              <span className="text-lg font-bold font-display bg-gradient-to-r from-white to-cyan-200 bg-clip-text text-transparent">
                {APP_TITLE}
              </span>
            </Link>
          ...
          {/* Quick links */}
          <div className="space-y-6">
            <h4 className="font-semibold text-foreground font-display">快速链接</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="flex items-center gap-2 text-sm text-muted hover:text-cyan-400 transition-colors group">
          ...
          {/* More links */}
          <div className="space-y-6">
            <h4 className="font-semibold text-foreground font-display">关于我们</h4>
            <ul className="space-y-3">
              {[
          ...
          {/* Contact info */}
          <div className="space-y-6">
            <h4 className="font-semibold text-foreground font-display">联系我们</h4>
            <div className="space-y-4">
              <a
                href="tel:02787771732"
                className="flex items-center gap-3 text-sm text-muted hover:text-cyan-400 transition-colors group"
              >
