                  ...
                  <div key={idx} className="flex gap-6">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      {idx < timeline.length - 1 && (
                        <div className="w-1 h-20 bg-gradient-to-b from-blue-500 to-blue-500/20 mt-2"></div>
                      )}
                    </div>
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-slate-600">成功案例</p>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold gradient-text mb-2">1000+</div>
                <p className="text-slate-600">服务客户</p>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold gradient-text mb-2">100+</div>
                <p className="text-slate-600">技术团队</p>
              </div>
            </div>
          </div>
        </section>
