                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 rounded-lg bg-slate-800 border border-cyan-500/30 text-foreground placeholder-foreground/50 focus:border-cyan-400 focus:outline-none transition-colors"
                        placeholder="请输入您的姓名"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full px-4 py-2 rounded-lg bg-slate-800 border border-cyan-500/30 text-foreground placeholder-foreground/50 focus:border-cyan-400 focus:outline-none transition-colors resize-none"
                      placeholder="请输入您的消息"
                    ></textarea>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full px-6 py-3 rounded-lg bg-gradient-accent text-background font-semibold hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300"
                  >
                    发送消息
                  </button>
                </form>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="tech-card">
                <div className="flex items-start gap-4">
                  <Clock className="w-12 h-12 text-cyan-400 flex-shrink-0" />
                  <div>
