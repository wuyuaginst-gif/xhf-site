                ...
                <div key={position.id} className="tech-card group">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-slate-500">月薪</p>
                    </div>
                  </div>

                  {/* Requirements */}
                  <div className="border-t border-blue-100 pt-4">
                    <h4 className="font-semibold text-sm mb-3 text-slate-900">岗位要求：</h4>
                  ...
                  <div className="mt-4 flex justify-end">
                    <button className="px-6 py-2 rounded-lg bg-blue-50 text-blue-600 border border-blue-200 hover:bg-blue-100 hover:border-blue-300 transition-all">
                      立即申请
                    </button>
                  </div>
                </div>
          ...
          <div className="container">
            <div className="max-w-2xl mx-auto text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <a href="mailto:hbxhf@hbxhf.com.cn" className="inline-flex items-center gap-2 px-8 py-3 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-all duration-300">
                  投递简历
                </a>
                <a href="tel:02787771732" className="inline-flex items-center gap-2 px-8 py-3 rounded-lg border border-blue-200 text-blue-600 font-semibold hover:bg-blue-50 hover:border-blue-400 transition-all duration-300">
                  联系我们
                </a>
              </div>
            </div>
